...
## 📁 檔案2：`utils/ui_components.py` (完整版)
...
### 1️⃣ 先上傳 `main.py` (使用我之前提供的完整版本)
### 2️⃣ 再上傳 `pages/home_page.py` (上方的完整版本)  
### 3️⃣ 最後上傳 `utils/ui_components.py` (上方的完整版本)
